...
static MenuAction add_game = ACTION_GAME;
...
void game_action_menu_open(Game *game) {
    ...
    ActionMenuItem *game_item = action_menu_level_add_action(s_level, "Add game to Favorites", action_click_callback, &add_game);
